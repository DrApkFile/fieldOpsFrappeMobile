...
const createStyles = (theme: any) => StyleSheet.create({
  ...
  emptyText: { fontFamily: theme.fonts.regular, fontSize: 13, color: theme.colors.darkMuted, textAlign: 'center' },
  widgetCard: { backgroundColor: theme.colors.darkCard, borderColor: theme.colors.darkBorder, gap: 6 },
  widgetTitle: { fontFamily: theme.fonts.bold, fontSize: 12, color: theme.colors.darkMuted, letterSpacing: 0.4 },
  widgetValue: { fontFamily: theme.fonts.display, fontSize: 24, color: theme.colors.darkText },
  widgetSupporting: { fontFamily: theme.fonts.regular, fontSize: 12, color: theme.colors.darkMuted },
  track: { height: 6, backgroundColor: theme.colors.darkBorder, borderRadius: 3, overflow: 'hidden', marginTop: 4 },
  ...
  stageName: { fontFamily: theme.fonts.semibold, fontSize: 13, color: theme.colors.darkText },
  stageCount: { fontFamily: theme.fonts.regular, fontSize: 12, color: theme.colors.darkMuted },
});
